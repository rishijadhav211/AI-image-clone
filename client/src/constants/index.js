export const surpriseMePrompts = [
    'A serene forest scene where trees are growing out of giant mechanical gears',
    'An otherworldly waterfall flowing with streams of liquid light amidst a futuristic cityscape',
    'A hummingbird-like robotic creature sipping nectar from bioluminescent flowers',
    'A mountain range with peaks resembling computer circuitry, lit up by a neon aurora',
    'A cybernetic butterfly with intricate circuit patterns on its wings, perched on a digital flower',
    'A tranquil beach with holographic palm trees and a virtual reality headset washed ashore',
    'A lush garden where robotic vines entwine with organic blooms, creating a harmonious blend',
    'A spaceship resembling a giant seed, launching from an earthy launchpad covered in moss',
    'A biomechanical dragonfly soaring over a landscape of digital dunes and sand waves',
    'A mechanical sunflower with solar panels for petals, generating energy as it follows the sun',
